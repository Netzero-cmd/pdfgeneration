function generateZurichKotakPolicyHTML(policyData) {
    ...
    return `
        ...
        <head>
            <meta charset="UTF-8">
            <title>Zurich Kotak Car Policy - ${policyData.policyNo}</title>
            <style>
        ...
        <body>
            <div class="policy-box">
                <div class="header">
                    <p style="color: #ff6600; font-weight: bold; margin: 0;">ZURICH kotak General Insurance</p>
                    <h1>Certificate cum Policy Schedule - Car Secure</h1>
                    <h2>Comprehensive Policy</h2>
                    <p style="margin-top: 10px; font-size: 11pt;"><span style="font-weight: bold;">Policy/Certificate No: ${policyData.policyNo}</span> | Issued on: ${policyData.issueDate}</p>
                </div>

function generateMagmaHDICVPolicyHTML(policyData) {
    ...
    return `
        ...
        <head>
            <meta charset="UTF-8">
            <title>Magma HDI CV Policy - ${policyData.policyNo}</title>
            <style>
        ...
        <body>
            <div class="policy-box">
                <div class="header">
                    <p style="color: #004d99; font-weight: bold; margin: 0;">MAGMA HDI General Insurance Company Ltd.</p>
                    <h1>COMMERCIAL VEHICLE CLASS (GCV) PACKAGE POLICY</h1>
                    <h2>Policy Schedule cum Certificate of Insurance</h2>

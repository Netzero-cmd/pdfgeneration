function generateNewIndiaTwoWheelerPolicyHTML(policyData) {
    ...
    return `
        ...
        <head>
            <meta charset="UTF-8">
            <title>New India Assurance Policy - ${policyData.policyNo}</title>
            <style>
        ...
        <body>
            <div class="policy-box">
                <div class="header">
                    <p style="color: #a80000; font-weight: bold; margin: 0;">THE NEW INDIA ASSURANCE CO. LTD. (Government of India Undertaking)</p>
                    <h1>POLICY SCHEDULE CUM CERTIFICATE OF INSURANCE</h1>
                    <h2>Bundled Motor Policy for Two Wheeler - Enhanced Covers</h2>
                    <p style="margin-top: 10px; font-size: 11pt;">Policy Number: <span style="font-weight: bold;">${policyData.policyNo}</span> | Tax Invoice No: ${policyData.taxInvoiceNo}</p>
                </div>

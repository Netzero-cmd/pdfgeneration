function generateReliancePolicyHTML(policyData) {
    ...
    return `
        ...
        <head>
            <meta charset="UTF-8">
            <title>Reliance Policy - ${policyData.policyNo}</title>
            <style>
        ...
        <body>
            <div class="policy-box">
                <div class="header">
                    <h1>RELIANCE TWO WHEELER POLICY BUNDLED - POLICY SCHEDULE</h1>
                    <p class="bold">Policy Number: ${policyData.policyNo}</p>
                    <p>Tax Invoice Date: ${policyData.invoiceDate} | Proposal/Covernote No: ${policyData.proposalNo}</p>
                </div>

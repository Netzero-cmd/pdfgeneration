function generateLibertyCommercialPolicyHTML(policyData) {
    ...
    return `
        ...
        <head>
            <meta charset="UTF-8">
            <title>Liberty Commercial Policy - ${policyData.policyNo}</title>
            <style>
        ...
        <body>
            <div class="policy-box">
                <div class="header">
                    <p style="color: #0056b3; font-weight: bold; margin: 0;">LIBERTY GENERAL INSURANCE LIMITED</p>
                    <h1>COMMERCIAL VEHICLE PACKAGE POLICY</h1>
                    <h2>Certificate of Insurance cum Policy Schedule - Goods Carrying Vehicles</h2>
                    <p style="margin-top: 10px; font-size: 11pt;">Policy Ref No: <span style="font-weight: bold;">${policyData.policyNo}</span> | Issued on: ${policyData.issueDate}</p>
                </div>

function generateShriramGICVPolicyHTML(policyData) {
    ...
    return `
        ...
        <head>
            <meta charset="UTF-8">
            <title>Shriram General CV Policy - ${policyData.policyNo}</title>
            <style>
        ...
        <body>
            <div class="policy-box">
                <div class="header">
                    <p style="color: #0056b3; font-weight: bold; margin: 0;">SHRIRAM GENERAL INSURANCE COMPANY LIMITED</p>
                    <h1>CERTIFICATE CUM POLICY SCHEDULE</h1>
                    <h2>MOTOR COMMERCIAL VEHICLE (PACKAGE POLICY)</h2>
                    <p style="margin-top: 10px; font-size: 11pt;">Policy No: <span style="font-weight: bold;">${policyData.policyNo}</span> | Issue Date: ${policyData.issueDate}</p>
                </div>

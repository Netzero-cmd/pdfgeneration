function generateUniversalSompoPolicyHTML(policyData) {
    ...
    return `
        ...
        <head>
            <meta charset="UTF-8">
            <title>Universal Sompo Policy - ${policyData.policyNo}</title>
            <style>
        ...
        <body>
            <div class="policy-box">
                <div class="header">
                    <p style="color: #004c99; font-weight: bold; margin: 0;">Universal Sompo General Insurance Company Limited</p>
                    <h1>Certificate of Insurance cum Policy Schedule</h1>
                    <h2>Motor Two Wheeler - Bundled Policy</h2>
                    <p style="margin-top: 10px; font-size: 11pt;"><span style="font-weight: bold;">Policy Number: ${policyData.policyNo}</span> | Issued Date: ${policyData.issueDate}</p>
                </div>

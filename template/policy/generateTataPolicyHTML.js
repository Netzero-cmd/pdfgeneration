function generatePolicyForTataHTML(policyData) {
    ...
    return `
        ...
        <head>
            <meta charset="UTF-8">
            <title>TATA AIG Policy - ${policyData.policyNo}</title>
            <style>
        ...
        <body>
            <div class="policy-box">
                <div class="header">
                    <p class="bold" style="color: #c00; margin-bottom: 2px;">TATA AIG INSURANCE</p>
                    <h1>Bundled Auto Secure - Two Wheeler Policy</h1>
                    <h2>(1 Year Term for Own Damage & 5 Years for Third Party)</h2>
                    <p style="margin-top: 15px;">**Policy No. ${policyData.policyNo}** | Issued: ${policyData.issueDate}</p>
                </div>

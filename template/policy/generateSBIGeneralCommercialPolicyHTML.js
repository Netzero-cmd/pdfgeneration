function generateSBIGeneralCommercialPolicyHTML(policyData) {
    ...
    return `
        ...
        <head>
            <meta charset="UTF-8">
            <title>SBI General Commercial Vehicle Policy - ${policyData.policyNo}</title>
            <style>
        ...
        <body>
            <div class="policy-box">
                <div class="header">
                    <p style="color: #0056b3; font-weight: bold; margin: 0;">SBI GENERAL INSURANCE (SURAKSHA AUR BHAROSA DONO)</p>
                    <h1>SCHEDULE CUM CERTIFICATE</h1>
                    <h2>COMMERCIAL VEHICLE INSURANCE POLICY-PACKAGE (PASSENGER CARRYING)</h2>
                    <p style="margin-top: 10px; font-size: 11pt;">Policy/Certificate No: <span style="font-weight: bold;">${policyData.policyNo}</span> | Policy Issue Date: ${policyData.issueDate}</p>
                </div>

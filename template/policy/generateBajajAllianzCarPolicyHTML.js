function generateBajajAllianzCarPolicyHTML(policyData) {
    ...
    return `
        ...
        <head>
            <meta charset="UTF-8">
            <title>Bajaj Allianz Car Policy - ${policyData.policyNo}</title>
            <style>
        ...
        <body>
            <div class="policy-box">
                <div class="header">
                    <p style="color: #cc0000; font-weight: bold; margin: 0;">BAJAJ ALLIANZ GENERAL INSURANCE COMPANY LTD.</p>
                    <h1>CERTIFICATE OF INSURANCE CUM POLICY SCHEDULE</h1>
                    <h2>Private Car Package Policy</h2>
                ...
                <div class="section-title">A. Proposer Details</div>

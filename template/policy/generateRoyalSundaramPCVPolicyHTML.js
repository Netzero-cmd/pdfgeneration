function generateRoyalSundaramPCVPolicyHTML(policyData) {
    ...
    return `
        ...
        <head>
            <meta charset="UTF-8">
            <title>Royal Sundaram Car Policy - ${policyData.policyNo}</title>
            <style>
        ...
        <body>
            <div class="policy-box">
                <div class="header">
                    <p style="color: #ed1c24; font-weight: bold; margin: 0;">Royal Sundaram General Insurance Co. Limited</p>
                    <h1>PRIVATE CAR POLICY</h1>
                    <h2>CERTIFICATE OF INSURANCE CUM POLICY SCHEDULE</h2>
                    <p style="margin-top: 10px; font-size: 11pt;">Policy No: <span style="font-weight: bold;">${policyData.policyNo}</span> | Next Renewal: ${policyData.nextRenewalDate}</p>
                </div>

function generateDigitCarPolicyHTML(policyData) {
    ...
    return `
        ...
        <head>
            <meta charset="UTF-8">
            <title>Digit Car Policy - ${policyData.policyNo}</title>
            <style>
        ...
        <body>
            <div class="policy-box">
                <div class="header">
                    <p style="color: #f60; font-weight: bold; margin: 0;">Go Digit General Insurance Ltd.</p>
                    <h2>Digit Private Car Policy</h2>
                    <h1>Certificate of Insurance / Policy Schedule</h1>
